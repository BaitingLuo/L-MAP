...
dataset_config = utils.Config(
    ...
    action_sequence_length=args.macro_step,
)
...
if args.task_type == "locomotion":
    ...
    transition_dim = obs_dim + args.macro_step*act_dim + 2
else:
    transition_dim = 128+args.macro_step*act_dim+3

#######################
######## model ########
#######################

#Leave it as this for flexibility of design
...
wandb.init(project="L-MAP", config=args, tags=[args.exp_name, args.tag])
